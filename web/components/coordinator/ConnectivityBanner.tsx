...
export default function ConnectivityBanner({ tier }: { tier: ConnectivityTier }) {
  ...
  return (
    <div
      role="status"
      className={`pointer-events-none fixed left-1/2 top-3 z-50 flex max-w-[min(92vw,560px)] -translate-x-1/2 items-start gap-2 rounded-card border px-3.5 py-2 shadow-overlay ${cls}`}
    >
