// lib/mockData.ts
//
// Demo fixtures only. Domain types live in lib/types/coordinator — this file holds demo
// *data* of those shapes, so removing it later doesn't disturb the types the app is built on.
import type {
  FieldReport,
  Team,
  Volunteer,
